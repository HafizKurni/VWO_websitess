    ...
    <body id="bd" class="page page-id-264 page-template page-template-template-blog-timeline page-template-template-blog-timeline-php  wpb-js-composer js-comp-ver-4.4.2 vc_responsive tribe-theme-everline">
        ...
        <div class="everline_boxed">
            ...
            <div class="about-page">
                                ...
                                <div class="wpb_gmaps_widget wpb_content_element">
                                    <div class="wpb_wrapper">
                                        <div class="wpb_map_wraper">
                                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d26081603.294420466!2d-95.677068!3d37.06250000000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1svi!2s!4v1423542244203"></iframe>		</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="vc_row wpb_row vc_row-fluid vc_custom_1423542533482">
                    <div class="container">
                        <div class="row">
                            <div class="vc_col-sm-12 wpb_column vc_column_container ">
                                <div class="wpb_wrapper">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 col-sm-4">
                                                    <div class="tzphone">
                                                        ...
                                                        <span>+44 (0) 800 765 4321</span>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-sm-4">
                                                    <div class="tzaddress">
                                                        <i class="fa fa-map-marker"></i>
                                                        <address>No.200 Joseph Road, Canada</address>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-sm-4">
                                                    <div class="tzemail">
                                                        <i class="fa fa-envelope"></i>
                                                        <span>info@templaza.com</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="vc_row wpb_row vc_row-fluid vc_custom_1423543196376">
                    <div class="nocontainer">
                        <div class="vc_col-sm-12 wpb_column vc_column_container ">
                            <div class="wpb_wrapper">
                                <h3 class="everline_title">CONTACT US</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="vc_row wpb_row vc_row-fluid vc_custom_1423542579311">
                    <div class="container">
                        <div class="row">
                            <div class="vc_col-sm-12 wpb_column vc_column_container ">
                                <div class="wpb_wrapper">
                ...
                <div class="vc_row wpb_row vc_row-fluid vc_custom_1423543278726">
                    <div class="nocontainer">
                        <div class="vc_col-sm-12 wpb_column vc_column_container ">
                            <div class="wpb_wrapper">
                                <div class="wpcf7" id="wpcf7-f455-p449-o1" lang="en-US" dir="ltr">
                                    <div class="screen-reader-response"></div>
                                    <form name="" action="/everline/contact/#wpcf7-f455-p449-o1" method="post" class="wpcf7-form" novalidate="novalidate">
                                        <div>
                                            <input type="hidden" name="_wpcf7" value="455" />
                                            <input type="hidden" name="_wpcf7_version" value="4.1" />
                                            <input type="hidden" name="_wpcf7_locale" value="en_US" />
                                            <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f455-p449-o1" />
                                            <input type="hidden" name="_wpnonce" value="58f1f4c33c" />
                                        </div>
                                        <div class="container contact-element">
                                            <div class="row">
                                                <div class='col-md-6'>
