...
<!--<![endif]-->
    ...
    <body id="bd" class="page page-id-264 page-template page-template-template-blog-timeline page-template-template-blog-timeline-php  wpb-js-composer js-comp-ver-4.4.2 vc_responsive tribe-theme-everline">
        ...
        <div class="about-page">
            <div class="vc_row wpb_row vc_row-fluid vc_custom_1423539106438">
                <div class="container">
                    <div class="row">
                                ...
                                <div class="wpb_single_image wpb_content_element vc_align_center">
                                    <div class="wpb_wrapper">        
                                        <div class="vc_single_image-wrapper   vc_box_border_grey">
                                            <img src="http://placehold.it/1170x400" class="vc_single_image-img attachment-full" alt="about" />
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="vc_row wpb_row vc_row-fluid vc_custom_1423539216238">
                <div class="container">
                    <div class="row">
                        <div class="vc_col-sm-12 wpb_column vc_column_container ">
                            <div class="wpb_wrapper">
                                <h3 class="everline_title">HELLO WE’RE EVERLINE TEAM</h3>        
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="vc_row wpb_row vc_row-fluid vc_custom_1423539335742">
                <div class="container">
                    <div class="row">
                        <div class="vc_col-sm-12 wpb_column vc_column_container ">
                            <div class="wpb_wrapper">        
            ...
            <div class="vc_row wpb_row parallax vc_row-fluid vc_custom_1423536877498">
                                        ...
                                        <ul class="tz-quote">
                                            <li>
                                                ...
                                                <h3 class="title_testimonials">
                                                    <i class="fa fa-quote-left"></i>Better to have loved and lost, than to have never loved<i class="fa fa-quote-right"></i>
                                                </h3>
                                            ...
                                            <li>
                                                <i class="fa fa-heart-o icon_testimonials"></i>
                                                <h3 class="title_testimonials">
                                                    <i class="fa fa-quote-left"></i>Nulla facilisis vitae metus quis consequat<i class="fa fa-quote-right"></i>
                                                </h3>
                                                <span class="author_testimonials">~ ST.AUGUSTINE ~</span>
                                            </li>
                                            <li>
                                                <i class="fa fa-heart-o icon_testimonials"></i>
                                                <h3 class="title_testimonials">
                                                    <i class="fa fa-quote-left"></i>Integer vulputate molestie ante, vel pellentesque<i class="fa fa-quote-right"></i>
                                                </h3>
                                                <span class="author_testimonials">~ ST.AUGUSTINE ~</span>
                                            </li>
                                        </ul>
            ...
            <div class="vc_row wpb_row vc_row-fluid vc_custom_1423538832150">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">        
                                        <div class="col-md-3 col-sm-6">
                                            <div class="tzteam-item">
                                                <div class="tzteam-img">
                                                    <img src="http://placehold.it/270x270" class="attachment-full wp-post-image" alt="team1" />
                                                    <a class="team_readmore" href="#"><i class="fa fa-link"></i></a>
                                                </div>
                                        ...
                                        <div class="col-md-3 col-sm-6">
                                            <div class="tzteam-item">
                                                <div class="tzteam-img">
                                                    <img src="http://placehold.it/270x270" class="attachment-full wp-post-image" alt="team2" />
                                                    <a class="team_readmore" href="#"><i class="fa fa-link"></i></a>
                                                </div>
                                                <div class="tzteam-meta">
                                                    <h4>
                                        ...
                                        <div class="col-md-3 col-sm-6">
                                            <div class="tzteam-item">
                                                <div class="tzteam-img">
                                                    <img src="http://placehold.it/270x270" class="attachment-full wp-post-image" alt="team3" />
                                                    <a class="team_readmore" href="#"><i class="fa fa-link"></i></a>
                                                </div>
                                                <div class="tzteam-meta">
                                                    <h4>
                                        ...
                                        <div class="col-md-3 col-sm-6">
                                            <div class="tzteam-item">
                                                <div class="tzteam-img">
                                                    <img src="http://placehold.it/270x270" class="attachment-full wp-post-image" alt="team4" />
                                                    <a class="team_readmore" href="#"><i class="fa fa-link"></i></a>
                                                </div>
                                                <div class="tzteam-meta">
                                                    <h4>
